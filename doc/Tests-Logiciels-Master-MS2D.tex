...
================================================================= 11 passed in 0.04s ======
        ...
        \begin{itemize}
            \item S'il est détecté par les tests, qu'une sanction au moins change, il est dit \textquote{tué}.
...
TypeError: expected str, bytes or os.PathLike object, not Mock
    ...
    \begin{frame}{Les tests d'intégration}{Exercice \execcounterdispinc{}}
        \begin{columns}
            ...
            \bigbreak
            Ajouter la fonction de connection BLE à un appareil défini par son adresse et lire la caractéristique \textquote{GATT} \lstinline{2A24}.
...
job_build:
  ...
  - Docker
    ...
    \begin{frame}{Stubbing et Mocking}{Qu'est-ce que le stubbing et le mocking~?\footnote{\label{fowler-stub-mock}Mocks Aren't Stubs, \url{https://martinfowler.com/articles/mocksArentStubs.html}}}
        \begin{itemize}
            \item Mock et Stub sont parfois appelés des \textquote{doubles} de test.
            Dans le sens où ils sont le double d'un objet, autre que le SUT (\textquote{Sytem Under Test}).
            ...
            Les objets mockés sont souvent appelés \textquote{collaborateurs}~.
            \item Le stub, A.K.A. bouchon, est un objet qui simule un objet réel.
            Ses interactions avec le SUT doivent être le proche possible de celles de l'objet réel.
    ...
    \begin{frame}{Stubbing et Mocking}{Mock VS Stub\footnote{When to Mock, \url{https://enterprisecraftsmanship.com/posts/when-to-mock/}}}
        \begin{columns}
            \column{0.5\textwidth}
            S'il n'y a pas de valeur retournée, comme dans une commande par exemple, on se tourne évidemment vers les Mock. Pourquoi \emoji{red-question-mark}
            \bigbreak
    ...
    \begin{frame}{Stubbing et Mocking}{Classique, Mock ou Stub la conclusion de M. Fowler}
        ...
        \begin{columns}
            ...
            Écrire les deux voir trois types de tests, classiques et avec doubles pour réduire les bugs, isoler le code et le décorréler les développements (éviter le \textquote{tuilage}).
            \column{0.5\textwidth}
            \centering
...
class OrderStateTester...
  public void testOrderSendsMailIfUnfilled() {
    ...
    \begin{frame}[fragile]{Stubbing}{Exercice \execcounterdispinc, Redaction d'un test bouchonné}
        Le but est d'écrire un test bouchonné qui test le même SUT que \href{https://github.com/St-Michel-IT/testing/blob/master/test_customer_database.py}{\lstinline{test_customer_database.py}} pour venir le compléter.
        \begin{itemize}
            \item Identifier le SUT de ce test.
            \item Identifier le(s) double(s).
            \item Développer le(s) bouchon(s).
            \item Rédiger le test bouchonné équivalent à \href{https://github.com/St-Michel-IT/testing/blob/master/test_customer_database.py}{\lstinline{test_customer_database.py}}.
            \item Jouer le test et produire le rapport.
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Conclusion}
        \centering
        \begin{large}
            \textquote{Write tests until fear is transformed into boredom}\footnote{Kent Beck, Test-Driven Development: By Example}
        \end{large}
        \bigbreak
